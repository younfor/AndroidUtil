...
public class TcpClient {
	...
	Game game=null;
	public void register(String args[]) throws IOException, InterruptedException
	{
		try {
			SocketAddress serveraddress = new InetSocketAddress(args[0], Integer.parseInt(args[1]));
			SocketAddress hostaddress = new InetSocketAddress(args[2], Integer.parseInt(args[3]));
			socket=new Socket();
