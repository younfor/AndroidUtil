...
./gameserver -gip 127.0.0.1 -seq replay -r 30 -d 0 -m 4000 -b 20 -t 2000 -h 600 -i 2000 0</dev/null 1>/dev/null 2>/dev/null &>"errserver.txt" & 
popd >/dev/null
...
./game77 127.0.0.1 6000 127.0.0.6 6006 6666 0</dev/null 1>/dev/null &>"err6666.txt" &
