...
export 
nohup ./gameserver -gip 127.0.0.1 -seq replay -d 1 -m 10000 -b 50 -t 2000 -h 200 0</dev/null 1>/dev/null 2>/dev/null  & 
popd >/dev/null
...
nohup ./simple 127.0.0.1 6000 127.0.0.7 6007 7777 0</dev/null 1>/dev/null 2>/dev/null &
