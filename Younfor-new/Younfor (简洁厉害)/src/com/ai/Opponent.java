...
//对手模型
	...
	//任何位置
	public double raisenum[]=new double[3]; //翻牌前,翻牌后,转牌,河牌 加注数
	public double foldnum[]=new double[3]; //翻牌前,翻牌后,转牌,河牌 弃牌数
	public double callnum[]=new double[3]; //翻牌前,翻牌后,转牌,河牌 跟注数
	/*
